//===-- MSP430TransformAddrModePass.cpp - MSP430 optimization pass  ------===//
//
...
#define DEBUG_TYPE "msp430-addressing-mode-opt"

namespace {
class MSP430AddrModeOpt : public MachineFunctionPass {
public:
  static char ID;
  MSP430AddrModeOpt() : MachineFunctionPass(ID) {}
...
char MSP430AddrModeOpt::ID = 0;
}

FunctionPass *llvm::createMSP430AddrModeOptimizationPass() {
  return new MSP430AddrModeOpt();
}
...
bool MSP430AddrModeOpt::runOnMachineFunction(MachineFunction &MF) {
